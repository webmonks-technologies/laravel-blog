<?php namespace WebMonksBlog\Requests\Traits;

use WebMonksBlog\Models\WebMonksCategory;

/**
 * Class HasCategoriesTrait
 * @package WebMonksBlog\Requests\Traits
 */
trait HasCategoriesTrait
{
    ...
    public function categories()
    {
        ...
        $vals = WebMonksCategory::whereIn("id", array_keys($this->get("category")))->select("id")->limit(1000)->get();
