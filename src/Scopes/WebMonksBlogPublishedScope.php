...
class WebMonksBlogPublishedScope implements Scope
{
    /**
     * If user is logged in and canManageWebMonksBlogPosts() == true, then don't add any scope
