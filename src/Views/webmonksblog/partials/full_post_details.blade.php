...
<p class="blog_body_content">
    ...
    {{--@if(config("webmonksblog.use_custom_view_files")  && $post->use_view_file)--}}
    {{--                                // use a custom blade file for the output of those blog post--}}
    {{--   @include("webmonksblog::partials.use_view_file")--}}
    {{--@else--}}
...
@includeWhen($post->author,"webmonksblog::partials.author",['post'=>$post])
@includeWhen($categories,"webmonksblog::partials.categories",['categories'=>$categories])
