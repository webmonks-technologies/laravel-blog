        ...
        <div class="card m-4">
            <div class="card-body">
                ...
                <form
                        ...
                        method='post' action='{{route("webmonksblog.admin.languages.toggle_language", $language->id)}}' class='float-left'>
                    @csrf
                ...
                <form
                        ...
                        method='post' action='{{route("webmonksblog.admin.languages.destroy_language", $language->id)}}' class='float-right'>
                    @csrf
                    @method("DELETE")
