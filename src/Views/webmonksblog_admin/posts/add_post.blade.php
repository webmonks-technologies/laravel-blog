...
@section("content")
    ...
    <form id="add-post-form" method='post' action='{{route("webmonksblog.admin.store_post")}}'  enctype="multipart/form-data" >
    ...
    <script>
        //multi language
        var store_toggle_url = '{{route("webmonksblog.admin.store_post_toggle")}}';
