...
@section("content")
    ...
    <form id="edit-post-form" method='post' action='{{route("webmonksblog.admin.update_post",$post->id)}}'  enctype="multipart/form-data" >
        ...
        @csrf
        @include("webmonksblog_admin::posts.form", [
          'post' => $post,
    ...
    <script>
        //multi language
        var edit_toggle_url = '{{route("webmonksblog.admin.edit_post_toggle",$post->id)}}';
