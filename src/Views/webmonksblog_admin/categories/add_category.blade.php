...
@section("content")
    ...
    <form method='post' action='{{route("webmonksblog.admin.categories.create_category")}}'  enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <small id="category_slug_help" class="form-text text-muted">
                ...
                i.e. {{route("webmonksblog.view_category",[app('request')->get('locale'),""])}}/<u><em>this_part</em></u>. This must be unique (two categories can't
                share the same slug).
        ...
        <div class="form-group">
            ...
            <ul class="wtree">
                @include("webmonksblog_admin::categories._category_partial", ['category_tree' => $cat_roots])
            </ul>
        </div>
...
//        alert("A");
            ...
            $('#submit-btn').click(function (){
                ...
                $.post('{{route("webmonksblog.admin.categories.store_category")}}' ,
                    {
                        data: languageList,
                    ...
                    function(data, status){
                        ...
                        window.location.replace("{{route('webmonksblog.admin.categories.index')}}");
                    });
            });
