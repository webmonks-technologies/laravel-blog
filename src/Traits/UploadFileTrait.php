...
namespace WebMonksBlog\Traits;

use Illuminate\Http\UploadedFile;
use WebMonksBlog\Events\UploadedImage;
...
trait UploadFileTrait
{
     ...
     * This can be defined in the config file. If webmonksblog.memory_limit is false/null then it won't do anything.
    ...
    protected function increaseMemoryLimit()
    {
        ...
        if (config("webmonksblog.memory_limit")) {
    ...
    /**
     * @param WebMonksPost $new_blog_post
     ...
     * @throws \Exception
     */
    protected function UploadAndResize(WebMonksPostTranslation $new_blog_post = null, $suggested_title, $image_size_details, $photo)
    {
        ...
        // save image
        $resizedImage->save($destinationPath . '/' . $image_filename, config("webmonksblog.image_quality", 80));
