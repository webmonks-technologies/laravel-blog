...
class Search implements SearchInterface
{
     ...
     * @param string $search
     *
     * @return \Illuminate\Database\Eloquent\Collection|\WebMonksBlog\Laravel\Fulltext\IndexedRecord[]
     */
    ...
    public function searchQuery($search)
    {
        ...
        $titleWeight = str_replace(',', '.', (float) config('webmonksblog.search.weight.title', 1.5));
        $contentWeight = str_replace(',', '.', (float) config('webmonksblog.search.weight.content', 1.0));
        ...
        $query = IndexedRecord::query()
          ...
          ->orderByRaw(
            ...
            ->limit(config('webmonksblog.search.limit-results'));
