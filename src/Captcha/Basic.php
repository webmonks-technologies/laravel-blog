...
class Basic extends CaptchaAbstract
{
    ...
    {
        if (!config("webmonksblog.captcha.basic_question") || !config("webmonksblog.captcha.basic_answers")) {
    ...
    {
        return 'webmonksblog::captcha.basic';
    }
    ...
    public function rules()
    {
        $check_func = function ($attribute, $value, $fail) {
            $answers = config("webmonksblog.captcha.basic_answers");
