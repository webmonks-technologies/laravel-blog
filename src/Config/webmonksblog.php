...
//config for webmonks/laravel-blogger
...
return [
    ...
    'include_default_routes' => true, // set to false to not include routes.php for WebMonksReaderController and admin related routes. Default: true. If you disable this, you will have to manually copy over the data from routes.php and add it to your web.php.
    ...
    //                              @ini_set('memory_limit', config("webmonksblog.memory_limit"));
    ...
    'captcha' => [
        ...
        'captcha_type' => \WebMonksBlog\Captcha\Basic::class, // this should be a class that implements the \WebMonksBlog\Interfaces\CaptchaInterface interface
    ...
    'comments' => [
        ...
        //      'custom' (will load webmonksblog::partials.custom_comments, which you can copy to your vendor view dir to customise
